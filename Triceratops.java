...
public class Triceratops extends Dinosaur
{
    ...
    private int numEaten; //specific to the Triceratops class and not Dinosaur
    ...
    public Triceratops()
    {
        ...
        super("Triceratops"); //Calls the explicit constructor of the parent class
    ...
    {
        boolean win = false;
        int rand = (int)(Math.random()*55+45);
        int otherRand = 0;
